...
class GridViewGornushinde extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          child: ClipRRect(
            ...
            child: Image.asset(imageUrl, width: double.infinity, height: screenheight*0.35, fit: BoxFit.cover,),
          ),),
          Expanded(flex: 2,  
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(title, style: TextStyle(fontSize: screenwidth*0.04, fontWeight: FontWeight.bold),),
          ),)
        ],
      ),
    );
